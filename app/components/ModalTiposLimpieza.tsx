...
interface ModalTiposLimpiezaProps {
    isOpen: boolean;
    onClose: () => void;
    onUpdate: () => void;
}

export default function ModalTiposLimpieza({ isOpen, onClose, onUpdate }: ModalTiposLimpiezaProps) {
    ...
    const cargarTipos = async () => {
        ...
        try {
            ...
            alert('Error al cargar tipos de limpieza');
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleGuardarEdicion = async (id: number) => {
        ...
        try {
            ...
            alert('Error al actualizar tipo de limpieza');
        }
    };
    ...
    const handleAgregar = async () => {
        ...
        try {
            ...
            console.error('Error:', error);
            alert('Error al crear tipo de limpieza');
        }
    };
    ...
    const handleEliminar = async (id: number, nombre: string) => {
        ...
        try {
            ...
            console.error('Error:', error);
            alert('Error al eliminar tipo de limpieza');
        }
    };
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[80vh] flex flex-col">
                ...
                <div className="p-6 border-b border-gray-200">
                    <h2 className="text-2xl font-bold text-gray-800">Gestionar Tipos de Limpieza</h2>
                    <p className="text-sm text-gray-600 mt-1">
                        Administra los servicios de limpieza disponibles para tu lavadero
                    </p>
                </div>
                    ...
                    {loading ? (
                        ...
                        <div className="space-y-3">
                            ...
                            {agregando ? (
                                ...
                                >
                                    ➕ Agregar nuevo tipo de limpieza
                                </button>
                            )}
                        </div>
                    )}
